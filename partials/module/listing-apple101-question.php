	...
	<div class="module">
		...
		<div <?php post_class( 'media' ); ?>>
			...
			<div class="media-body">
				<h3 class="media-heading entry-title title-sm hidden"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h3>
				<span class="entry-meta"><?php $helper->t_entry_date(); ?></span>
				<div class="entry-summary">
					<?php echo do_shortcode( '[fw-question]<a href="' . get_permalink() . '">' . get_the_excerpt() . '</a>[/fw-question]' ); ?>	
				</div>
